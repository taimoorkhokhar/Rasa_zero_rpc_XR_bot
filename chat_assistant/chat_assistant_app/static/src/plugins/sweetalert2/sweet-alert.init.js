!function ($) {
    ...
    SweetAlert.prototype.init = function () {
        ...
        //Success Message
        $('#train-success-popup').click(function () {
            swal(
                {
                    type: 'success',
                    text: 'Assistant Trained Successfully',
        ...
        //Error Message
        $('#train-error-popup').click(function () {
            swal(
                {
                    type: 'error',
                    title: 'Oops...',
                    text: 'Something went wrong! During Training Try Again',
                }
            )
        });
